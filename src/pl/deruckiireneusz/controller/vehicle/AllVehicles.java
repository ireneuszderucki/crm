...
/**
 * Servlet implementation class AllVehicles
 */
...
public class AllVehicles extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			ArrayList<Vehicle> vehicles = VehicleDao.loadAllVehicles(conn);
			if (vehicles.isEmpty()) {
				String defaultMsg = "No vehicles so far";
		...
		getServletContext().getRequestDispatcher("/WEB-INF/views/AllVehicles.jsp")
